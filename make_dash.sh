...
MP4Box -dash 4000 -rap -out ./video/out/bbb_2400k_dash.mpd -segment-name 'bbb_2400k_' ./video/tmp/bbb_2400k.mp4
MP4Box -dash 4000 -rap -out ./video/out/bbb_1200k_dash.mpd -segment-name 'bbb_1200k_' ./video/tmp/bbb_1200k.mp4
MP4Box -dash 4000 -rap -out ./video/out/bbb_0600k_dash.mpd -segment-name 'bbb_0600k_' ./video/tmp/bbb_0600k.mp4

# Combine each MDP file into one big mpd file.
cat ./video/out/bbb_0600k_dash.mpd | awk 'BEGIN{ found=1} /\/AdaptationSet/{found=0} {if (found) print}' >> ./video/out/bbb_dash.mpd
...
cat ./video/out/bbb_2400k_dash.mpd | awk 'BEGIN{ found=0} /Representation/{found=1} {if (found) print}' | sed 's/id=\"1\"/id=\"3\"/' >> ./video/out/bbb_dash.mpd
